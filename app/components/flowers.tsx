type FlowersProps = {
    styles?: string,
    flowerPaddingTop?: number,
  }

export const Flowers = ({
    styles,
    flowerPaddingTop = 1000,
  } : FlowersProps
  ) => {
    let classContent = "container !w-screen !max-w-screen-xl !h-screen !max-h-[750px] " + styles;
    return (
      <div id="body_container" className={classContent} style={{ 'animation-play-state': 'running !important'} as React.CSSProperties}>
        <div className="night"></div>
        <div className={`flowers !pt-[50%]`}>
